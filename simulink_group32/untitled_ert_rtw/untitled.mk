...
## Generated on : Fri Oct 21 16:49:31 2022
...
START_DIR                 = C:/Users/anand/Desktop/3K04-Pacemaker-Project/simulink_group32
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
startup.o : C:/Freescale/KSDK_1.3.0/platform/devices/startup.c
	$(CC) $(CFLAGS) -o "$@" "$<"


system_MK64F12.o : C:/Freescale/KSDK_1.3.0/platform/devices/MK64F12/startup/system_MK64F12.c
	$(CC) $(CFLAGS) -o "$@" "$<"


startup_MK64F12.o : C:/Freescale/KSDK_1.3.0/platform/devices/MK64F12/startup/gcc/startup_MK64F12.S
	$(AS) $(ASFLAGS) -o "$@" "$<"
