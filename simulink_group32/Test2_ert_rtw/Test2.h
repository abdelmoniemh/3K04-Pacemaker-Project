...
typedef struct {
  freedomk64f_AnalogInput_Test2_T obj; /* '<Root>/Analog Input' */
  freedomk64f_DigitalRead_Test2_T obj_o;/* '<S4>/Digital Read1' */
  freedomk64f_DigitalRead_Test2_T obj_g;/* '<S4>/Digital Read' */
  freedomk64f_DigitalWrite_Test_T obj_m;/* '<S4>/Digital Write7' */
  freedomk64f_DigitalWrite_Test_T obj_k;/* '<S4>/Digital Write6' */
  freedomk64f_DigitalWrite_Test_T obj_e;/* '<S4>/Digital Write5' */
  freedomk64f_DigitalWrite_Test_T obj_ki;/* '<S4>/Digital Write4' */
  freedomk64f_DigitalWrite_Test_T obj_p;/* '<S4>/Digital Write3' */
  freedomk64f_DigitalWrite_Test_T obj_d;/* '<S4>/Digital Write2' */
  freedomk64f_DigitalWrite_Test_T obj_h;/* '<S4>/Digital Write10' */
  freedomk64f_DigitalWrite_Test_T obj_a;/* '<S4>/Digital Write1' */
  freedomk64f_DigitalWrite_Test_T obj_pu;/* '<S4>/Digital Write' */
  freedomk64f_PWMOutput_Test2_T obj_my;/* '<S4>/PWM Output2' */
  freedomk64f_PWMOutput_Test2_T obj_hy;/* '<S4>/PWM Output1' */
  freedomk64f_PWMOutput_Test2_T obj_mt;/* '<S4>/PWM Output' */
  ...
  uint8_T is_active_c3_Test2;          /* '<S1>/Chart' */
} DW_Test2_T;
 ...
 *
 * '<Root>' : 'Test2'
 * '<S1>'   : 'Test2/Pacemaker (click here)'
 * '<S2>'   : 'Test2/Pacemaker (click here)/Chart'
 * '<S3>'   : 'Test2/Pacemaker (click here)/Hardware Hiding'
 * '<S4>'   : 'Test2/Pacemaker (click here)/Hardware Hiding/Subsystem'
 */
